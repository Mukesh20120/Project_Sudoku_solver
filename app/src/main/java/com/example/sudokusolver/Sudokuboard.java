...
public class Sudokuboard extends View {
    ...
    private final int cellHighlighColor;
    ...
    private final Paint cellHighlighColorPaint = new Paint();
    ...
    public Sudokuboard(Context context, @Nullable AttributeSet attrs) {
        ...
        try{
            ...
            cellHighlighColor=a.getInteger(R.styleable.Sudokuboard_cellsHighlightColor,0);
    ...
    protected void onDraw(Canvas canvas){
     ...
     boardColorPaint.setAntiAlias(true);
        ...
        cellHighlighColorPaint.setStyle(Paint.Style.FILL);
        cellHighlighColorPaint.setAntiAlias(true);
        cellHighlighColorPaint.setColor(cellHighlighColor);
    ...
    private void drawThickLine(){
        boardColorPaint.setStyle(Paint.Style.STROKE);
        boardColorPaint.setStrokeWidth(11);
        boardColorPaint.setColor(boardColor);
    }
